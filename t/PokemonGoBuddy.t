...
sub build_ssbm_test { test_zci(build_structured_answer(@_)) }
...
ddg_goodie_test(
    ...
    'melee mario' => build_ssbm_test('Mario', $mario_data),

    'ssbm frame data mario' => build_ssbm_test('Mario', $mario_data),
